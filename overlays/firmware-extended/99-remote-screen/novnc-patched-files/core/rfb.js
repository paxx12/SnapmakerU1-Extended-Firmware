...
export default class RFB extends EventTargetMixin {
    constructor(target, urlOrChannel, options) {
        ...
        this._tapDelay = 50; // Default tap delay in ms
    }
    ...
    get tapDelay() {
        return this._tapDelay;
    }
    set tapDelay(delay) {
        if (!Number.isInteger(delay) || delay < 0 || delay > 200) {
            Log.Error("tapDelay must be an integer between 0 and 200ms");
            return;
        }
        this._tapDelay = delay;
    }
    ...
    _handleTapEvent(ev, bmask) {
        ...
        // Add small delay before button release to help framebuffer-vncserver process the event
        setTimeout(() => {
